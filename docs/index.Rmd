...
<iframe width='100%' height='80%' src='https://rdrr.io/snippets/embed/?code=mtcars%0A%0Alibrary(ggplot2)%0A%0Aggplot(mtcars%2C%20aes(x%3Dcyl%2C%20y%3Dmpg))%20%2B%0A%20%20%20%20%20%20%20geom_point()' frameborder='0'></iframe>
...
##<i class="fad fa-check-circle"></i>  Associated with Github repository
...
### Support those in your team doing the analyses to use these tools (eg. a statistician or a student)
